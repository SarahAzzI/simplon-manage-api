...
class Inscription(Base):
    ...
    statut = Column(
        String(50),
        default=StatutInscription.EN_ATTENTE.value,
        nullable=False
    )
    capacite_max = Column(Integer, nullable=True)  # Optionnel selon ta logique
    ...
    def __repr__(self):
        return f"<Inscription(id={self.id}, user_id={self.user_id}, statut={self.statut})>"